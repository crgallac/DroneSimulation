...
MODEL                := quadRotorSim
MODULES              := quadRotorSim_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := quadRotorSim.mk
...
#
MODELLIB                  := quadRotorSimlib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := quadRotorSim_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/moriarty-admin/Documents/MATLAB/DroneSimulation/quadRotorSim_rtwin_win64;C:/Users/moriarty-admin/Documents/MATLAB/DroneSimulation;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
